...
export function useNav(): NavItemResolved[] {
  return [
    ...
    // VIN check is consolidated into Telematics (search + lookup there).
    { to: '/telematics', labelKey: 'nav.telematics', icon: '📡', roles: ['admin', 'owner', 'sales', 'warehouse'], group: 'navGroup.autologic' },
    ...
    { to: '/addresses', labelKey: 'nav.addresses', icon: '📍', roles: ['admin', 'owner', 'sales'], group: 'navGroup.sales' },
    ...
    { to: '/admin', labelKey: 'nav.admin', icon: '⚙', roles: ['admin'], group: 'navGroup.system' },
